...
如果字符串例的内容全部是数字,则转换为数字,否则就是NaN;



其实就是调用的一种叫做转换函数Number();

**Number()内要是有一个内容不是数字**,就会返回NaN;
...
​     0,"",undefined,null,false,NaN ->这六种是转换为false,其余的全当做true来用("0"," "是true);
...
![img](https://app.yinxiang.com/shard/s15/res/b0af61da-f333-43c9-8890-ad5a471bd215.png)
